...
export const InputAgeField = () =>{
    const {setFieldState,fieldState,calcBtn,restField} = useContext(EggProvider);
    return(
         <>
            <input className=" border-b-2 mt-4 border-solid w-full text-greys mb-4 placeholder: indent-4 border-b-primary text-5xl"  type="text" onChange={(e) => setFieldState(e.target.value)} name="age" placeholder="Enter your Age" value={fieldState} />
